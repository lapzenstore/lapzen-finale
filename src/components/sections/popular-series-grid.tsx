...
const PopularSeriesSection = () => {
    const series = [
      ...
      },
      {
        ...
        href: "/series/lenovo-thinkpad",
        subtext: "Strong, reliable, and performance-driven."
      },
      {
        title: "Dell XPS",
        image: "https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/render/image/public/document-uploads/xps-1767201494398.jpeg?width=8000&height=8000&resize=contain",
        href: "/series/dell-xps",
        subtext: "Boundary-pushing design. The ultimate premium laptop."
      },
      {
        title: "HP Omen",
        image: "https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/render/image/public/document-uploads/omen-1767178081801.jpeg?width=8000&height=8000&resize=contain",
        href: "/series/hp-omen",
        subtext: "Gaming unleashed. High-performance gaming gear."
      },
        {
          title: "Lenovo Legion",
          image: "https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/render/image/public/document-uploads/legion-1767204792776.jpeg?width=8000&height=8000&resize=contain",
          href: "/series/lenovo-legion",
          subtext: "Stylish outside, savage inside. Pure gaming power."
        },
      {
        title: "Dell Precision",
        image: "https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/render/image/public/document-uploads/precision-1767178081799.jpeg?width=8000&height=8000&resize=contain",
        href: "/series/dell-precision",
        subtext: "Professional workstations. Performance without limits."
      },
        {
          title: "HP ZBook",
          image: "https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/render/image/public/document-uploads/zbook-1767201940243.jpeg?width=8000&height=8000&resize=contain",
          href: "/series/hp-zbook",
          subtext: "Power to create. The ultimate mobile workstation."
        },
        {
          title: "Lenovo Thinkbook",
          image: "https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/render/image/public/document-uploads/thinkbook-1767202143202.jpeg?width=8000&height=8000&resize=contain",
          href: "/series/lenovo-thinkbook",
          subtext: "Modern standby. Built for small business agility."
        },
      {
        title: "Toshiba",
        image: "https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/render/image/public/document-uploads/toshiba-2-1767201502533.jpeg?width=8000&height=8000&resize=contain",
        href: "/series/toshiba",
        subtext: "Leading innovation. Reliable technology for every user."
      },
        {
          title: "Asus",
          image: "https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/render/image/public/document-uploads/asus-1767204792775.jpeg?width=8000&height=8000&resize=contain",
          href: "/series/asus",
          subtext: "In search of incredible. Performance meets art."
        }
    ];
